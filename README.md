...
这样做有几个好处：
 ...
 最近我录制的全栈课程上线了 —— [方糖全栈课](https://quanzhanke.github.io/)。这里和大家分享一些录课的心得。
...
最后再说一下课程的内容选择。通常来讲，课程的录制成本差异并不大，但决定收益的是受众数量。跨语言技术型的通用课程可能会更受欢迎。比如正则表达式、版本管理系统的使用。反而一些比较有深度的能看懂的人不会太多。

这个看一下掘金小册的各种选材和他的销售数量，就大体可以感受到。

不是说我们非要去做一些很初级很通用，谁都能看的这种课，我是说你在录课之前，要对自己这个课的市场有一个基本认知。

面向超小众群体的深度课程，如果收费的话，客单价一定要足够高，才会有一个满意的收益。如果定价太便宜，可能还不如直接免费会更好。

当然，这个定价不是乱定的。而是说你要能给买这门课的同学带来一个两倍或者五倍的收益。这种收益可能是立竿见影的，也可能是在未来2到3年以内慢慢的表现出来的。总之，课程提供的价值要足够支撑它的定价。

全职来干这个事情（也有同学问），压力会比较大，我还是建议大部分同学先把录课作为我们以前写技术博客，做技术分享的一个更高阶的替代品。等你的课程的用户越来越多，你的影响力慢慢变大了，然后再来考虑专职做这个事情。

和以前写文章比起来，视频录制的话，信息量更大的成本更低，在同样的时间以内，你可以输出更多的东西。长得好看的同学还可以露露脸，涨点粉丝。

甚至不一定是课程，你也可以是一个一个的小的节目。比如说我之前拿机器语音生成的方糖技术分享，就打算做成这么一个小栏目。因为大家看起来确实会比看文章要更轻松一些，而微博现在对视频加权，传播量比文本大一些。
